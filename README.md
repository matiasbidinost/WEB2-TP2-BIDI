...
ENDPOINTS
agregar: localhost/WEB2-TP2-BIDI/api/ligas (POST)
modificar: localhost/WEB2-TP2-BIDI/api/ligas/id (PUT)
borrar: localhost/WEB2-TP2-BIDI/api/ligas/id (DELETE)
ver por id: localhost/WEB2-TP2-BIDI/api/ligas/id (GET)
ver general localhost/WEB2-TP2-BIDI/api/ligas(GET)

ENDPOINTS EQUIPO
agregar: localhost/WEB2-TP2-BIDI/api/equipos (PARAMETROS) (equipos o ligas)(POST)
actualizar: localhost/WEB2-TP2-BIDI/api/equipos/num (num=id del que va a modificar)(PARAMETROS) (equipos o ligas)(PUT)
